...
class Response extends Message implements ResponseInterface
{
     ...
     */
    public function __construct($status = 200, $headers = array(), StreamInterface $body = null)
    {
        $this->status = $this->filterStatus($status);
        $this->headerParams = new ResponseHeaderBag($headers);
    ...
    {
        return in_array($this->getStatusCode(), array(204, 205, 304));
    }
